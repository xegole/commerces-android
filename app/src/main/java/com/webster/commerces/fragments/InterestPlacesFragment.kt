...
import kotlinx.android.synthetic.main.fragment_interest_places.*

class InterestPlacesFragment : BaseFragment() {
    private val database = FirebaseDatabase.getInstance()
    private val emergencyReference = database.getReference(FirebaseReferences.PLACES)

    override fun resourceLayout() = R.layout.fragment_interest_places
    ...
    companion object {
        fun instance() = InterestPlacesFragment()
    }
}